...
<?php
if(isset($_POST['exampleInputEmaill'])) {

    $to = $_POST['exampleInputEmaill'];
    $subject = 'Validation';
    $message = 'hello';
    $headers = 'From: http://i388250.hera.fhict.nl' . "\r\n" .
        'Reply-To: http://i388250.hera.fhict.nl' . "\r\n" .
            ...
            <form action="#" method = "post" >
                <div class="form-group">
                    ...
                    <input type="email"
                           ...
                           id="exampleInputEmail1" name="exampleInputEmaill" aria-describedby="emailHelp" placeholder="Enter email">
